    ...
    <aside className="w-64 min-h-screen bg-card border-r border-border flex flex-col">
      ...
      <nav className="flex-1 p-3 space-y-1 overflow-y-auto">
        {navItems.map((item) => {
          ...
          return (
            ...
            >
              <item.icon className={cn('w-4 h-4 flex-shrink-0', isActive ? 'text-sky-400' : 'text-muted-foreground group-hover:text-foreground')} />
      ...
      <div className="p-3 border-t border-border">
        <button
          ...
          className="w-full flex items-center gap-3 px-3 py-2.5 rounded-lg text-sm text-muted-foreground hover:text-red-400 hover:bg-red-500/5 transition-all duration-200"
        >
